...
class GermanStemmer2(_StandardStemmer):

    """
    The German Snowball stemmer.
    This stemmer has been modified to not replace umlauts at the end of stemming (see code).
    ...
    def stem(self, word):
        ...
        # Modified: Do not replace umlauts
